<script lang="ts">
	...
	let {
		...
		easing = 'ease',
		speed = 200,
		shadow = `0 0 10px,0 0 5px`,
		template = `<div class="bar bg-app-500 rounded-full" role="bar"><div class="peg shadow-app-500"></div></div><div class="spinner" role="spinner"><div class="spinner-icon"></div></div>`,
		zIndex = 1600
	}: Props = $props();
